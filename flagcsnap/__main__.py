...
from stream import Controller
from parse_ipg import IPGParser
from parse_assemblies import AssemblyParser
from cluster_proteins import ProteinClusterer
from parse_taxonomy import TaxonomyParser
from arrange_data import Arranger
from basic_plot import Plotter
from extra_tools import ExtraAnnotation
from extra_plot import ExtraPlotter


from utils import console,log,validate_input_file
...
@click.option('--api-key', "apikey", default='0dd59f676839567a5bb2eb826cff33c8fc09', help='API Key.')
...
@click.option('--cand-mode',"cand_mode", default="best_id", help='Way to choose candidates to show among Identica Protein Groups')
@click.option('--win-mode',"mod", default='win_nts', help='Your mod description.')
@click.option('--win',"wn", default=20000, type=int, help='Your wn description.')
@click.option('--height-factor', default=20, type=int, help='Height factor.')
@click.option('--padloc', is_flag=True, help='Defense mode.')
@click.option('--deffinder', is_flag=True, help='Defense mode.')
@click.option('--tree-mode', default='fast_phylo', help='Tree mode.')
...
@click.option('--ncRNA',"ncrna", is_flag=True, help='ncRNA mode.')
@click.option('--cctyper', is_flag=True, help='cctyper mode.')
...
@click.option('--assembly-db', default=os.environ.get('CONDA_PREFIX')+"/db/fastgcsnap", help='Assembly DB name.')
